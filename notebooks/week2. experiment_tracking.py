...
# COMMAND ----------
experiment = mlflow.set_experiment(experiment_name="/Shared/term-deposit-basic")
mlflow.set_experiment_tags({"repository_name": "end-to-end-mlops-databricks-4/marvelous-databricks-course-srinis98"})
...
experiments = mlflow.search_experiments(
    filter_string="tags.repository_name='end-to-end-mlops-databricks-4/marvelous-databricks-course-srinis98'"
)
print(experiments)
...
run_id = mlflow.search_runs(
    experiment_names=["/Shared/term-deposit-basic"],
